...
namespace FinanceApp.Server.Data.Migrations
{
    ...
    [Migration("20220619155440_UseTickerAsLogoKey")]
    partial class UseTickerAsLogoKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceApp.Server.Models.Logo", b =>
                {
            ...
            modelBuilder.Entity("FinanceApp.Server.Models.Logo", b =>
                {
                    b.HasOne("FinanceApp.Server.Models.TickerDetails.TickerResults", "TickerResults")
                        .WithOne("Logo")
                        .HasForeignKey("FinanceApp.Server.Models.Logo", "Ticker")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
