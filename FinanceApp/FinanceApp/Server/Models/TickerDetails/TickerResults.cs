...
namespace FinanceApp.Server.Models.TickerDetails
{
    public class TickerResults
    {
        ...
        [JsonPropertyName("cik")] public string? Cik { get; set; } = null!;

        [JsonPropertyName("composite_figi")] public string? CompositeFigi { get; set; } = null!;
        ...
        [JsonPropertyName("sic_code")] public string? SicCode { get; set; } = null!;

        [JsonPropertyName("sic_description")] public string? SicDescription { get; set; } = null!;

        [JsonPropertyName("ticker_root")] public string? TickerRoot { get; set; } = null!;

        [JsonPropertyName("homepage_url")] public string? HomepageUrl { get; set; } = null!;
        ...
        public TickerResults(string ticker, string name, string market, string locale, string primaryExchange, string type,
            ...
            string phoneNumber, Server.Models.TickerDetails.Address address, string description, string sicCode,
